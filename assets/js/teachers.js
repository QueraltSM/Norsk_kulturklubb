...
<h4 style="text-align: center; margin: 0;">Hei, I'm <strong>${
        teacher.name
      }</strong></h4>
</div>
<div style="display: flex; align-items: center;padding-right: 5%;">
<div style="display: flex; align-items: center;">
<i style="font-size: 13px; margin-right: 5px;color:#ffc107;" class="fa fa-star ${
        teacher.rating >= 1 ? "checked" : ""
      }"></i>
...
`;
  ...
  .catch((error) => {
    ...
    document.getElementById("teacherData").textContent =
      "Error al obtener los datos del profesor." + error;
  });
